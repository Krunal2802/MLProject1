...
class ModelTrainer:
    ...
    def initiate_model_trainer(self,train_array,test_array):
        try:
            ...
            ## for hyper parameter tuning of the models
            ## you can also write this all params in .yaml file and from that file you are using this is the best way
            params={
                "Decision Tree": {
            ...
            model_report :dict = evaluate_model(
                ...
                y_test= y_test,
                models= models,
                params= params)  ## if hyperparameter tuning the model then this params is added 
